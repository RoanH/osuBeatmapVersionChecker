...
public class Converter
{
	...
	{
		System.out.println("Converting: " + sourceName + " to " + destName);
		...
		throws JavaLayerException
	{
		...
		try {
			...
			progressListener.converterUpdate(ProgressListener.UPDATE_FRAME_COUNT, countFrames(sourceStream) / 418, 0);
			int frame = 0;
	...
	protected int countFrames(InputStream in) throws IOException
	{
		return in.available();
	}
